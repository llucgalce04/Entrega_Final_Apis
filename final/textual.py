...
def compose(self) -> ComposeResult:
        ...
        yield Label("Api Rick and Morty", id="title")
...
def option_button_pressed(self, event: Button.Pressed) -> None:
    button_id = event.text.lower()

    if button_id == "randomimage":
        self.PersonajeRandom()
    elif button_id == "searchimage":
        self.BuscarPersonaje()
    elif button_id == "randomepisodio":
        self.EpisodioRandom()
    elif button_id == "searchepisodio":
        self.BuscarEpisodio()
    elif button_id == "randomlocate":
        self.RandomLocation()
    elif button_id == "searchlocation":
